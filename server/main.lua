...
RegisterServerEvent('esx_policejob:givecadet')
AddEventHandler('esx_policejob:givecadet', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('esx_policejob:giveofficierkit')
AddEventHandler('esx_policejob:giveofficierkit', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('esx_policejob:givelieutenantkit')
AddEventHandler('esx_policejob:givelieutenantkit', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('esx_policejob:givecommandantkit')
AddEventHandler('esx_policejob:givecommandantkit', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
