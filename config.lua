...
Config.EnableESXIdentity          = false -- activer si vous utilisez esx_identity
Config.EnableNonFreemodePeds      = false -- activez cette configuration si vous souhaitez utiliser des peds personnalisés
Config.EnableLicenses             = false -- activer si vous utilisez esx_license

Config.EnableHandcuffTimer        = true -- activer la minuterie des menottes? ne sera pas libre joueur après la fin du temps
Config.HandcuffTimer              = 10 * 60000 -- 10 mins

Config.EnableJobBlip              = true -- activer les blips pour les collègues, nécessite esx_society
